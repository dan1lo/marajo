...
$q1= "SELECT * FROM tabela_foto where tipo='$tipo' limit $Start, $ByPage";
...
if($lrows > '0')
{
	...
	while($a1 = mysql_fetch_array($r1))
	{
		...
		if(!empty($a1[image]))
		{
			...
			echo "<a href =\"#\" onclick=\"window.open('http://www.marajotecidos.com.br/teste/fotos_anuncios/$MyImage', 'Márajo Tecidos - $MyImage', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=770, HEIGHT=400');\"><img src=\"fotos_anuncios/$MyImage\" width=117 height=88 border=1 > </a>"; 
		}
		else
		{
...
<a href='carrinho.php?cod=".$a1[cod]."&acao=incluir'><img src='imagens/add_carrinho.jpg'</a>
	...
	echo "</table>";
		$q2= "SELECT * FROM tabela_foto where tipo='$tipo'";
		...
		if ($Start>0){
					$Start = $Start-10;
					echo "| <a href=\"produtoscript2.php?Start=$Start&tipo=$tipo\" >Anterior</a>";
				
				}
				
			if($rows>$ByPage){	
			echo "| <a href=\"produtoscript2.php?Start=$ByPage&tipo=$tipo\" >Proximo </a>";
			}
		echo "</td>";
